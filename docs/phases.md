...
The long-form record: what each phase measured, what it cost, and what broke. The
[README](../README.md) carries the benchmark and the design; this carries the working.
